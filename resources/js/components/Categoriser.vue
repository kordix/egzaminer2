<template>
  <div class="col-md-4">
    ...
    <div class="" v-for="category in categories" @click="currentcategory=category.id">
    ...
    <p style="width:300px"><button  class="btn btn-sm btn-secondary" @click="showcasebool = !showcasebool" style="float:right;display:block">showcase</button></p>
    <div class="" id="listagen" style="overflow-y:auto;height:300px">

            <div style="display:flex" v-for="item in wordsFilter">
